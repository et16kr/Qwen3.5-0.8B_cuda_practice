...
- 로컬 모델 디렉터리: `/home/et16/aps/images/Qwen3.5-0.8B`
...
GPU 비교군으로는 CUDA-enabled `torch`가 필요합니다. 이 저장소를 점검할 때는
`/home/et16/venv/vllm` 환경의 `torch 2.10.0+cu128`를 사용해 Hugging Face GPU
출력을 기준값으로 삼았습니다.
...
MODEL_DIR=/home/et16/aps/images/Qwen3.5-0.8B \
...
.venv/bin/python ./scripts/run_text_generation.py \
  --model-dir /home/et16/aps/images/Qwen3.5-0.8B \
...
```bash
./main -m /home/et16/aps/images/Qwen3.5-0.8B \
...
```bash
/home/et16/venv/vllm/bin/python ./scripts/compare_hf_logits.py \
  --model-dir /home/et16/aps/images/Qwen3.5-0.8B \
  --prompt "Explain Qwen3.5 linear attention briefly."
```
...
- `qwen_forward()`는 아직 CPU 기준 경로를 사용합니다.
...
- 비교 기준: `/home/et16/venv/vllm` 환경의 Hugging Face GPU 실행
- 모델: `/home/et16/aps/images/Qwen3.5-0.8B`
- forward logits 비교:
